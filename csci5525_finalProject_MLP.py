...
param_dist = {	
				...
				'hidden_layer_sizes':[(5,),(25,),(50,),(100,),(5,5),(5,25),(5,75),(5,100),(25,25),(25,50),(25,100),(50,25),(50,50),(50,100),(75,100),(100,100)],
				#'alpha':[1e-5],
				'random_state':[1]
             }
...
for train_ix, test_ix in cv_outer.split(X):
	...
	search = RandomizedSearchCV(clf, param_dist, cv=cv_inner, verbose=10)
	#search = GridSearchCV(clf, param_dist, cv=cv_inner, verbose=10)
	...
	acc = 1 - mean_absolute_error(y_test, yhat)
...
print('Inner Fold Accuracy: %.3f (%.3f)' % (np.mean(inner_results), np.std(inner_results)))
print('Outer Fold Accuracy: %.3f (%.3f)' % (np.mean(outer_results), np.std(outer_results)))
